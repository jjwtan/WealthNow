...
public class Order {
	...
	public Order(Integer user_id, Integer order_id, String currency_code, String order_type, Integer quantity,
			String stock_symbol, String price_type, Date opening_order_date, Float limit_price, String term, String status) {
		...
		this.opening_order_date = opening_order_date;
	 ...
	 */
	public Order(Integer user_id, Integer order_id, String currency_code, String order_type, Integer quantity,
			String stock_symbol, String price_type, Date opening_order_date, Float limit_price,
			Date order_completion_date, String status) {
		this.user_id = user_id;
		this.order_id = order_id;
		this.currency_code = currency_code;
		this.order_type = order_type;
	...
	public Date getOpening_order_date() {
		return opening_order_date;
	}
	public void setOpening_order_date(Date opening_order_date) {
		this.opening_order_date = opening_order_date;
	}
	...
	public String toString() {
		return "Order [user_id=" + user_id + ", order_id=" + order_id + ", currency_code=" + currency_code
				...
				+ ", price_type=" + price_type + ", opening_order_date=" + opening_order_date + ", limit_price="
